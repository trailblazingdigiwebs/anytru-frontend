        ...
        <div className="postWrapper">
            <div className="userOptions">
                <div className="postUserDetails">
                    <div className="userAvatar"><img src="/images/temp/temp2.png" /></div>
                    <div className="userName"><p>Pranjalikashi.1<span>1 h</span></p></div>
            ...
            <div className="MainPostWrapper">
                <div className="MainPost">
                    <div className="post">
                        <img src="/images/temp/post-temp2.png" />
